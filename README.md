...
A basic front-end link sharing/posting and voting website that allows users to sign in, share links, comment on them, and vote on them.

The backend provides the API and database saving logic for the site.
